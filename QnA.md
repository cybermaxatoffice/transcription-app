...
# 📋 시니어 맞춤형 앱 개발 프롬프트 가이드

이 문서는 AI(ChatGPT, Gemini 등)에게 단 한 번의 요청으로 완벽한 프론트엔드 소스코드를 얻어내기 위한 최적화 프롬프트 모음입니다. 새 채팅창을 열고 필요한 프롬프트를 그대로 복사해서 사용하세요.

---

## 1. ✍️ 필사 서비스 전용 최적화 프롬프트
